...
public class Solution {
    ...
    public static void main(String[] args) {
        try {fileManager.copyFile("book.txt", "book_final_copy.txt");
        fileManager.copyFile("book_final_copy.txt", "book_last_copy.txt");}
        catch (RuntimeException e) {
            Throwable exc = e.getCause();
            if (exc instanceof FileSystemException) System.out.println(FAILED_TO_WRITE);
            if (exc instanceof FileNotFoundException) System.out.println(FAILED_TO_READ);
        }
